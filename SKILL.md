---
name: codex-doctor
description: Diagnose Codex CLI disk usage, bloated ~/.codex sessions/logs, Codex cache growth, and common macOS developer caches. Use when Codex is asked to inspect, explain, report, or safely clean local Codex CLI storage, rollout JSONL files, logs_2.sqlite files, ~/Library/Caches/com.openai.codex, Xcode DerivedData, CoreSimulator, pip/npm/pnpm/yarn caches, or Homebrew cache.
---
